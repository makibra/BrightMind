...
const handleDelete = async (idCours) => {
  try {
    ...
    if (docSnapshot.exists()) {
      const currentFavCourses = docSnapshot.data().myFavCourses || [];
      ...
      await updateDoc(studentDocRef, { myFavCourses: updatedFavCourses });
      console.log(`Course ID ${idCours} has been deleted from myFavCourses.`);
...
const CustomCard: React.FC<CardProps> = ({id, title , instructor , imageUrl }) => { 
